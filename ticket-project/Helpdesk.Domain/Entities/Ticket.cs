...
public class Ticket
{
    ...
    public void Reopen(string justification)
    {
        if (State != TicketState.Resolved)
    ...
    public void CloseAfterGracePeriod()
    {
        if (State != TicketState.Resolved)
            throw new InvalidOperationException(
                "Solo los tickets resueltos pueden cerrarse por vencimiento del plazo de gracia.");
